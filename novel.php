...
<body style="font-size:3.3em;font-family: 'Vollkorn', serif;">
...
<hr>
<p class="endnote">This edition of <i>Around The World in <?=$articlecount?> Wikipedia Articles</i> was autogenerated on
<?=date("l jS \of F Y")?> using the Wikipedia articles named in full in each paragraph, taken from
a route passing through the <a href="http://www.kmjn.org/notes/geographically_dense_wikipedia.html">ten most Wikipedia-documented metropolitan areas</a>, and 
run through a generative
script written by <a href="http://kevan.org">Kevan Davis</a> for <a href="https://github.com/dariusk/NaNoGenMo-2015">NaNoGenMo</a> in November 2015. The articles' text was made available under a Creative Commons Attribution-ShareAlike License, and the
text of this edition is released under that same licence.</p>
<?
exit;
